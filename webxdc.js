...
window.alterXdcApp = () => {
  var styleControlPanel =
    "position: fixed; bottom:1.5rem; left:1.5rem; background-color: #000; opacity:0.8; padding:.5rem; font-family: sans-serif; color:#fff; z-index: 9999";
  var styleMenuLink =
    "color:#fff; text-decoration: none; vertical-align: middle";
  var styleAppIcon =
    "height: 1.5rem; width: 1.5rem; margin-right: 0.5rem; border-radius:10%; vertical-align: middle";
